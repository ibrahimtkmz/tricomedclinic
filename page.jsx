    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .hero-lobby-bg {
            position: absolute;
            inset: 0;
            background-image: linear-gradient(100deg, rgba(0,0,0,0.88) 10%, rgba(0,0,0,0.55) 55%, rgba(0,0,0,0.8) 100%), url('https://images.unsplash.com/photo-1634141510639-d691d86f47be?auto=format&fit=crop&w=2200&q=80');
        ...
        .hero-soft-overlay {
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at 76% 48%, rgba(212, 175, 55, 0.18), transparent 35%);
            z-index: -1;
        }
    </style>
</head>
        ...
        <div class="h-full flex items-start justify-end p-6 md:p-10">
            <div class="w-full max-w-sm glass-panel rounded-[30px] p-8 border border-[#d4af37]/30">
                ...
                <nav class="space-y-5 text-[11px] tracking-[3px] uppercase font-bold text-white/70">
                    ...
                    <a class="block text-[#d4af37] hover:text-white transition" href="#contact">Book Appointment</a>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="container mx-auto grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div class="lg:col-span-5 relative hidden lg:block">
                <div class="float-anim">
                    <div class="relative w-full aspect-square glass-panel rounded-full overflow-hidden p-4 border-[#d4af37]/30 border-[10px] shadow-[0_20px_80px_rgba(0,0,0,0.5)]">
