...
<body>
    ...
    <!-- Header -->
    <header id="main-header" class="fixed top-0 w-full z-[1000] py-6 transition-all duration-700 header-divider">
    ...
    <div id="menu-popup" class="menu-popup fixed inset-0 z-[1100] bg-black/75 backdrop-blur-md">
        <div class="h-full flex items-center justify-center p-6 md:p-10">
            <div class="w-full max-w-sm glass-panel rounded-[30px] p-8 border border-[#d4af37]/30 max-h-[90vh] overflow-y-auto">
                ...
                <nav class="space-y-5 text-[11px] tracking-[3px] uppercase font-bold text-white/70">
                    <a class="block hover:text-[#d4af37] transition" href="#">Home</a>
                    <a class="block hover:text-[#d4af37] transition" href="#results">Cases</a>
                    <a class="block hover:text-[#d4af37] transition" href="#tech">Technology</a>
                    <a class="block hover:text-[#d4af37] transition" href="#journey">Journey</a>
                    <a class="block hover:text-[#d4af37] transition" href="#blog">Clinic Academy</a>
                    <button type="button" class="open-contact-form block text-[#d4af37] hover:text-white transition">Book Appointment</button>
                </nav>
            </div>
        </div>
    </div>
        ...
        <div class="container mx-auto grid lg:grid-cols-12 gap-10 items-center">
            <div class="lg:col-span-7 z-10">
                ...
                <div class="flex flex-wrap gap-6">
                    <button type="button" class="open-contact-form px-12 py-6 bg-[#d4af37] text-black font-bold text-[10px] tracking-[4px] uppercase hover:bg-white transition-all shadow-[0_10px_40px_rgba(212,175,55,0.3)]">
                        Free Analysis
                    </button>
            ...
            <div class="lg:col-span-5 relative hidden lg:block">
                <div class="float-anim">
                    <div class="relative w-full aspect-square glass-panel rounded-full overflow-hidden p-4 border-[#d4af37]/30 border-[10px]">
                         <img src="arkaplan-2.png" class="w-full h-full object-cover rounded-full grayscale hover:grayscale-0 transition-all duration-700" alt="Specialist Surgeon">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto">
            ...
            <div class="bento-grid">
                ...
                <div class="col-span-12 lg:col-span-4 glass-panel p-10 rounded-[40px] group">
                    ...
                    <h3 class="serif-elite text-2xl mb-4 text-[#d4af37] flex items-center gap-3">Sapphire Clinic Blade <i data-lucide="laugh" class="w-5 h-5"></i></h3>
            ...
            <div class="relative timeline-line">
                ...
                <div class="grid md:grid-cols-2 gap-20 mb-32 relative">
                    ...
                    <div>
                        ...
                        <h4 class="serif-elite text-3xl mb-4 text-[#d4af37] flex items-center gap-3">Operation Day <i data-lucide="laugh" class="w-6 h-6"></i></h4>
    ...
    <section id="blog" class="py-40 bg-zinc-950">
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-end mb-24">
                <h2 class="serif-elite text-5xl md:text-7xl flex items-center gap-4">Clinic <span class="text-[#d4af37]">Academy</span> <i data-lucide="laugh" class="w-10 h-10 text-[#d4af37]/80"></i></h2>
            ...
            <div class="swiper academySwiper overflow-visible">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="glass-panel p-10 rounded-[40px] group cursor-pointer">
                            <div class="w-full h-64 rounded-3xl overflow-hidden mb-8 relative">
                                <img src="https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?auto=format&fit=crop&q=80" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-110" alt="Blog 3">
                                <div class="absolute top-4 right-4 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full text-[8px] font-bold tracking-widest text-[#d4af37]">CARE</div>
                            </div>
                            <h3 class="serif-elite text-2xl mb-4 group-hover:text-[#d4af37] transition">Funny Truths About Post-Op Hair Washing</h3>
                            <p class="text-white/40 text-sm mb-8">A practical guide to washing routine mistakes with easy fixes from our medical team.</p>
                            <i data-lucide="arrow-right" class="w-6 h-6 text-[#d4af37] group-hover:translate-x-3 transition"></i>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="glass-panel p-10 rounded-[40px] group cursor-pointer">
                            <div class="w-full h-64 rounded-3xl overflow-hidden mb-8 relative">
                                <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&q=80" class="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-110" alt="Blog 4">
                                <div class="absolute top-4 right-4 bg-black/60 backdrop-blur-md px-4 py-2 rounded-full text-[8px] font-bold tracking-widest text-[#d4af37]">PLANNING</div>
                            </div>
                            <h3 class="serif-elite text-2xl mb-4 group-hover:text-[#d4af37] transition">How We Design Cartoon-Like Natural Hairlines</h3>
                            <p class="text-white/40 text-sm mb-8">See the sketch-to-reality process behind soft temple angles and natural forehead framing.</p>
                            <i data-lucide="arrow-right" class="w-6 h-6 text-[#d4af37] group-hover:translate-x-3 transition"></i>
                        </div>
                    </div>
                </div>
        ...
        <div class="h-full flex items-center justify-center p-6">
            <div class="w-full max-w-xl glass-panel rounded-[30px] p-6 md:p-8 border border-[#d4af37]/30 max-h-[90vh] overflow-y-auto">
                ...
                <form id="contact-form" class="space-y-4">
                    <input id="contact-name" type="text" placeholder="Full Name" required class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#d4af37]">
                    <input id="contact-phone" type="tel" placeholder="Phone Number" required class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#d4af37]">
                    <input id="contact-email" type="email" placeholder="Email" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#d4af37]">
                    <textarea id="contact-message" placeholder="Your Request" rows="4" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 focus:outline-none focus:border-[#d4af37]"></textarea>
                    <button type="submit" class="w-full px-8 py-4 bg-[#d4af37] text-black font-bold text-[11px] tracking-[4px] uppercase hover:bg-white transition-all">
                        Gönder ve WhatsApp'ta Aç
                    </button>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        const openContactButtons = document.querySelectorAll('.open-contact-form');
        ...
        contactForm.addEventListener('submit', (event) => {
            ...
            const whatsappUrl = `https://wa.me/905467372284?text=${encodeURIComponent(text)}`;
